...
const ModalEdit = styled(ModalStyles)`
    height: 70vh;
  ...
  return (
    ...
    >
      <Formulario>
        <div>
          <Label>Usuário</Label>
          <Campos err={errors?.user} {...register("user" ,{required: true})} autoComplete="off" placeholder="Abner de Oliveira Quintiliano"></Campos>
        ...
        <Confirmar type="button" onClick={() => handleSubmit(onSubmit)()}>Editar</Confirmar>
      </Formulario>
    </ModalEdit>
  );
}
